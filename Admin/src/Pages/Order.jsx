    ...
    <div className="p-6 max-w-4xl mx-auto">
      ...
      <div className="flex items-center justify-between mb-6">
        ...
        <button onClick={fetchAllOrders}
          className="flex items-center gap-2 px-4 py-2 border border-gray-200 rounded-xl text-sm text-gray-600 hover:bg-gray-50 transition cursor-pointer">
          ↻ Refresh
        </button>
      </div>
          ...
          <div key={order._id}
            ...
            <div className="flex items-start justify-between gap-4 flex-wrap mb-4">
              ...
              <div className="flex flex-col items-end gap-1">
                <span className={`text-xs px-3 py-1 rounded-full font-medium ${statusStyle[order.status]}`}>
                  {order.status}
                </span>
            ...
            <div className="border-t border-gray-100 pt-3 mb-4">
              ...
              <div className="flex flex-wrap gap-2">
                {order.items.map((item, i) => (
                  <span key={i}
                    className="text-xs bg-gray-50 border border-gray-200 rounded-lg px-3 py-1 text-gray-700">
            ...
            <div className="flex items-center justify-between flex-wrap gap-3">
              ...
              <div className="flex items-center gap-2">
                ...
                <select
                  ...
                  className="text-xs border border-gray-200 rounded-xl px-3 py-1.5 outline-none focus:border-orange-400 cursor-pointer bg-white">
